...
public:
    ...
    void DrawMesh(Mesh& mesh, Texture& texture, glm::mat4 proj, glm::vec3 position, float scale, glm::vec3 rotation, Camera camera, Texture& normalsTexture,
        string shaderName = "default", glm::vec3 color = glm::vec3(1.f, 0.f, 0.f), float brightness = 1.f);
...
private:
    ...
    std::shared_ptr<Shader> shaderRed;
